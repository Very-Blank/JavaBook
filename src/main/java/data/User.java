...
public class User extends Data<User> {
    ...
    public User(int ID, String name, String email, String countryCode, String phoneNumber, ArrayList<Integer> loans, LocalDate birthday) {
        super(ID);
        this.name = name;
        this.email = email;
    ...
    public User copy() {
        ...
        return new User(this.getID(), this.name, this.email, this.phoneNumber, this.countryCode, newList, this.birthday);
    }
